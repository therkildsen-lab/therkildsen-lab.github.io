...
draft = false
title = "Age prediction in Atlantic Sturgeon"
...
![epigenetic clock](https://images-provider.frontiersin.org/api/ipx/f=webp/https://www.frontiersin.org/files/Articles/441753/xml-images/fgene-10-00107-g002.webp)
_Epigenetic Clock, from Xiao, Wang, & Kong 2019_

Using Enzymatic Methyl-sequencing (EM-seq, [Vaisvila et al. 2021](https://doi.org/10.1101/gr.266551.120)), we will be screening tens of thousands of candidate methylation sites to develop a predictive model of age in wild Atlantic Sturgeon. By building a robust and unbiased model that performs consistently across sexes and populations, this project aims to deliver a practical, management-ready tool to improve stock assessments and support long-term conservation of this species.

![Official EM-Seq schematic](https://genome.cshlp.org/content/genome/31/7/1280/F2.large.jpg)
_EM-Seq, from Vaisvila et al. 2021_